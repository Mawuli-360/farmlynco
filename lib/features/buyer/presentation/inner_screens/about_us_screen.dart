...
class AboutUsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    const String aboutUsHtml = '''
      ...
      <p>Welcome to our <span>Allinagri app</span>, a revolutionary platform designed to empower farmers by connecting them directly to buyers. Our goal is to enhance the agricultural value chain by facilitating seamless interactions between farmers and buyers, thereby increasing resource optimization and market access.</p>
